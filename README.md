...
*   **Galería Masonry Unificada con Visor Lightbox:**
    ...
    *   **Estructura Adaptativa de 7 Columnas:** Distribución automática responsiva de imágenes (2 columnas en móviles, 3 en tablets, 5 en pantallas medianas y 7 columnas completas en resoluciones de escritorio >=1200px).
