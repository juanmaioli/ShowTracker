...
*   **Dashboard Optimizado:** Tarjetas de series un 20% más compactas (grilla de 6 columnas en resoluciones de pantalla grandes) y ordenadas alfabéticamente de forma predeterminada.
