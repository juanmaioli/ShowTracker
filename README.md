...
*   **Almacenamiento Completo de Artworks sin Límites:** Descarga completa de todos los pósters e imágenes de fondo (*backgrounds*) disponibles en TheTVDB hacia directorios locales (`public/img/posters/` y `public/img/backgrounds/`) sin límites artificiales de cantidad. Cuenta con verificación de archivos existentes en disco para evitar re-descargas innecesarias y procesamiento en lotes paralelos de 8 descargas para un rendimiento óptimo.
*   **Elenco Completo (Cast) con Visor Lightbox y Enlace a TMDB:** Almacenamiento y descarga de fotos de todos los actores del elenco en `public/img/cast/` sin límite artificial de cantidad, procesado en lotes paralelos de 8 en red, con filtrado y deduplicación de actores por nombre e índices únicos en SQLite. Al hacer clic en cualquier actor, se abre un modal lightbox independiente con navegación por teclado, tarjeta con nombre del actor vinculado directamente a su perfil en **TheMovieDB (TMDB)**, personaje, contador y enlace para abrir la foto original en alta resolución.
...
*   **Galería de Artworks con Contador y Visor Lightbox:**
    *   **Encabezado y Contador en Alto Contraste:** Título simplificado a **Artworks** acompañado de una insignia violeta destacada en alto contraste con el número total de posters y fondos disponibles.
