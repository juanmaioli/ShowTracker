...
*   **Almacenamiento Completo de Artworks con Caché Local:** Descarga inteligente de posters e imágenes de fondo (backgrounds) en directorios locales (`public/img/posters/` y `public/img/backgrounds/`). Cuenta con verificación de archivos locales existentes en disco para evitar re-descargas innecesarias y se paraleliza en lotes simultáneos de 8 descargas para prevenir saturaciones de red.
