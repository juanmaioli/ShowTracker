...
*   **Elenco Principal (Cast) con Visor Lightbox y Enlace a TMDB:** Almacenamiento y descarga de fotos de los actores principales en `public/img/cast/` (máximo de 12 por serie) con filtrado y deduplicación de actores por nombre e índices únicos en la base de datos. Al hacer clic en cualquier actor, se abre un modal lightbox independiente y desconectado de la galería de artworks con navegación por teclado, tarjeta con nombre del actor vinculado directamente a su perfil en **TheMovieDB (TMDB)**, personaje, contador y enlace para abrir la foto original en alta resolución.
