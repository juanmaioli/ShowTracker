...
*   **Elenco Principal (Cast) Deduplicado:** Almacenamiento y descarga de fotos de los actores principales en `public/img/cast/` (máximo de 12 por serie) con filtrado y deduplicación de actores por nombre e índices únicos en la base de datos, mostrándose en una cuadrícula de 8 columnas con retratos circulares.
